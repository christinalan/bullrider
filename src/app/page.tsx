        ...
        <div className="flex flex-col w-full justify-center gap-1 z-10">
          ...
          <div className="flex w-full justify-center items-center pt-4 sm:pt-6">
            <button
              ...
              className={`${bullriderFont.className} text-[38px] sm:text-[50px] text-[#812C27] text-center rotate-[-7deg] sm:rotate-[-9deg] mt-[-6px] sm:mt-[0px] px-6 py-[2px] sm:py-[4px] outline outline-[3.6px] outline-[#812C27] leading-none cursor-pointer transition-transform duration-200 hover:scale-105 active:scale-95`}
            >
              Connect Wallet
            </button>
          </div>
